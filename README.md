...
crates/         # 19 crates
  ...
  qumbra-wallet/      # the end-user wallet CLI: keygen/restore/address/backup/scan — deliberately no send yet (#219/mint)
