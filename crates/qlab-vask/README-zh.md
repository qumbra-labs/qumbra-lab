...
| 数字 | 值 | 基础 |
|---|---|---|
| 信封大小 | **184,689 B**(约 180 KiB;重做创世第二批后隐藏 PCS 的 rc = 0——rc = 4 时为 189,437 B,安全重铸前为 150,695 B) | 已提交的 V1 黄金 fixture:钉定 b16/q20/g22/a16 配置下 postcard 序列化的证明(`fixtures/README.md`——注意旧文档里流传的"~122 KB"是 bincode 证明大小,编解码器弄错了) |
