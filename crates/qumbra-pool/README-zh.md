...
一行由 ⬜ 翻 ✅,只发生在协调者验收之时,绝不在"写完了"之时。最后更新 2026-08-22 01:20 +08。
...
| **🎉 一个矿工被这个矿池付过钱** | ✅ **2026-08-22 01:19 +08,高度 1776** —— 4.992690888 QMB 直接进矿工自己的地址;lab #553 已关 |
...
| 项 | 状态 | 卡在 |
|---|---|---|
| 真正挖出一个块,并读出它的收款人 | ✅ **做了两次 —— 先坏后好** | 08-21:三个块全付给矿池自己。08-22:高度 1776 付给了矿工。 |
