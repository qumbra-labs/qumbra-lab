...
| op | µs/op | ops/s |
|---|---|---|
| full-FO decap (path a) | 18.529 | 53969 |
| encap (re-encryption proxy) | 15.266 | 65504 |
| **FO-skip decap (path b, decomposition est.)** | **3.263** | **306493** |

- FO-skip compute saved ≈ **82.4%** (UPPER bound); speedup factor ≈ **5.68×**
